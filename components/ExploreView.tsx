    ...
    <div className="flex flex-col space-y-12 py-6 px-6 pb-24 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <section className="space-y-8">
        <div className="text-center pt-6 space-y-4">
          <h1 className="text-[64px] font-serif text-gray-900 tracking-tight leading-none italic" style={{ fontFamily: 'Georgia, serif' }}>
            Beauty
          </h1>
        ...
        {/* Beauty Tabs */}
        <div className="sticky top-0 z-30 bg-[#F7F9FA]/90 backdrop-blur-xl border-b border-gray-100 -mx-6 px-6 overflow-x-auto no-scrollbar">
            ...
            {BEAUTY_CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`relative py-1 text-[11px] font-black tracking-[1.5px] uppercase transition-all ${
                    isActive ? 'text-gray-900' : 'text-gray-400 hover:text-gray-600'
                  }`}
                >
                  {cat.name}
                  {isActive && (
                    <div className="absolute -bottom-1 left-0 right-0 h-1 bg-gray-900 rounded-full animate-in slide-in-from-left duration-300" />
                  )}
                </button>
              );
            })}
        ...
        {/* Beauty Content Detail */}
        <div className="grid grid-cols-1 gap-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <a 
          ...
          >
            <div className="relative aspect-[4/5] rounded-[56px] overflow-hidden shadow-2xl bg-zinc-900 mb-6 border border-gray-50">
              <img 
                src={activeCategoryData.image} 
                alt={activeCategoryData.name} 
                className="w-full h-full object-cover opacity-80 transition-transform duration-[2000ms] group-hover:scale-110" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-10">
                <div className="flex items-center space-x-2 mb-4">
                  <span className="px-4 py-1.5 bg-[#26A69A] text-white text-[9px] font-black uppercase tracking-widest rounded-full">Editorial Spotlight</span>
                ...
                <div className="flex items-center space-x-3 text-white/50 text-[10px] font-black uppercase tracking-[3px] group-hover:text-white transition-colors">
                  <span>Visit Vogue Beauty Archive</span>
